...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    and doesn'0t force `first_name` or `last_name` 
    """
    ...
    wallet_address= models.CharField(_('waddress'), max_length=42, blank=True,help_text=_('Required. Ethereum address in hex format (with "0x" prefix).'),
                                      validators=[
                                          validators.RegexValidator(re.compile(
